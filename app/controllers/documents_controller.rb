class DocumentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @document.save
        format.html {
          if @document.ticket_id == nil
            redirect_to site_path(@document.site, :anchor => get_doctype(@document)), notice: 'Document was successfully created.'
          else
            redirect_to ticket_path(@document.ticket), notice: 'Document was successfully created.'
          end
        }
  ...
  def document_params
    params.require(:document).permit(:title, :file, :site_id, :ticket_id, :doctype)
  end
