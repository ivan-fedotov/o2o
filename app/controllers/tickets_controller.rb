class TicketsController < ApplicationController
  ...
  def index
    ...
    @authors = Account.where(is_client: true).order('time_new asc')
  ...
  def show
    ...
    @documents = Document.where(ticket_id: @ticket.id)
    @document = @ticket.documents.new
