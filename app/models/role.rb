class Role < ApplicationRecord
  ...
  after_create do |r|
    ...
    rp = r.role_permissions.new(status_id: nil)
    rp.permissions = '{"edit_permissions"=>"0", "edit_roles"=>"0", "edit_statuses"=>"0", "edit_ticket_types"=>"0", "edit_accounts"=>"0", "get_reports"=>"0", "edit_prices"=>"0", "edit_brigades"=>"1", "see_brigade"=>"1", "see_site"=>"1", "edit_sites"=>"0", "view_docs"=>"1", "edit_docs"=>"1", "open_ticket"=>"1", "see_ticket"=>"1", "edit_ticket"=>"1", "send_ticket_message"=>"0", "see_reported"=>"1"}'
    rp.save
  end
end
