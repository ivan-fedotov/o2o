...
class RolePermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create role_permission" do
    assert_difference('RolePermission.count') do
      post role_permissions_url, params: { role_permission: { permissions: @role_permission.permissions, role_id: @role_permission.role_id, status_id: @role_permission.status_id } }
    end
  ...
  test "should update role_permission" do
    patch role_permission_url(@role_permission), params: { role_permission: { permissions: @role_permission.permissions, role_id: @role_permission.role_id, status_id: @role_permission.status_id } }
